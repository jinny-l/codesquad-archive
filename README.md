...
| 기간                         | 학습 분야         | Gist                                                                                                                                                                                 |
|:---------------------------|:--------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `23-01-02 ~ 23-01-06` [5d] | 개발 환경과 데이터 구조 | [CS01 - 개발환경과 리눅스]() <br/> [CS02 - 영상 목록 편집]()                                                                                                                                       |
| `23-01-09 ~ 23-01-13` [5d] | 컴퓨터 아키텍처      | [CS03 - CPU 시뮬레이터](https://gist.github.com/jinny-l/08799282859a6e70135a2f9c12c5fe2c) <br/> [CS04 - 프로세스 메모리 시뮬레이터](https://gist.github.com/jinny-l/97bb5d5cdf65c0a2ee9624de8c3e99cd) |
| `23-01-16 ~ 23-01-20` [5d] | 객체지향 프로그래밍    | [CS05 - 다각형]() <br> [CS06 - 체스 게임](https://gist.github.com/jinny-l/f674d04bb085617acb401283e41a7db7)                                                                                 |
| `23-01-23 ~ 23-01-27` [5d] | 컴파일러          | [CS07 - XML 파서](https://gist.github.com/jinny-l/f89b6056c0cff3a23ea7cb1d9356279a)                                                                                                    |
| `23-01-30 ~ 23-02-03` [5d] | 함수형 프로그래밍     | [CS08 - 정수 분류기]() <br/> [CS09 - 함수형 Set]()                                                                                                                                           |
| `23-02-06 ~ 23-02-10` [5d] | 운영체제          | [CS10 - 프로세스 스케줄링](https://gist.github.com/jinny-l/eb922868f8a416ed63c199ff1f3c7349) <br/> [CS11 - 카페 주문 이벤트]()                                                                      |
| `23-02-13 ~ 23-02-17` [5d] | 네트워크          | [CS12 - HTTP 분석기](https://gist.github.com/jinny-l/eb922868f8a416ed63c199ff1f3c7349) <br/> [CS13 - HTTP 클라이언트](https://gist.github.com/jinny-l/3a2b3866e8c80ca6b9bebc40852bbd28)      |
| `23-02-20 ~ 23-02-24` [5d] | 데이터베이스        | [CS14 - 데이터베이스 설치](https://gist.github.com/jinny-l/aa8828e2096b8dabf4bbf5635824cb8b) <br/> [CS15 - PC방 관리자](https://gist.github.com/jinny-l/2427385e3441aeb799624a48b0955dc8)        |
| `23-02-27 ~ 23-02-28` [5d] | 개발 환경, 버전관리   | [CS16 - 버전관리와 PR]()                                                                                                                                                                  |


### 블로그 포스팅
> 9주간 총 15개 포스트, 주 평균 2회 작성
...
| 미션              | 기간                         | 회고   |
|:----------------|:---------------------------|:-----|
| 웹 서버 미션 - 1~3단계 | `23-05-08 ~ 23-05-12` [5d] |      |
| 웹 서버 미션 - 4~5단계 | `23-05-15 ~ 23-05-19` [5d] |      |
| 웹 서버 미션 - 6~7단계 | `23-05-22 ~ 23-05-26` [5d] |      |
| 웹 서버 미션 - 8단계   | `23-05-29 ~ 23-06-02` [5d] | []() |
...
## 🌱 4월 - Spring 미션
> - 요약: Spring으로 "게시판 CRUD"를 구현하는 미션 (Review와 Code Review 진행)
...
`Builder` `DTO` `Entity` `Annotation` `MySQL` `AWS 배포` `SQL`
...
## ☕️ 3월 - Java 미션
> - 요약: Java로 "사다리 게임", "로또 게임", "게시판"을 구현하는 미션
> - 기간: `23-03-06 ~ 23-03-24`
...
| [로또 게임](https://github.com/jinny-l/be-java-lotto-max)            | `23-03-13 ~ 23-03-17` [5d] | [[코드스쿼드] Max 2주차 회고 - 로또 미션](https://velog.io/@jinny-l/%EC%BD%94%EB%93%9C%EC%8A%A4%EC%BF%BC%EB%93%9C-Max-2%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0)    | |
| [게시판(자바스크립트)](https://github.com/jinny-l/be-javascript-cafe-max) | `23-03-20 ~ 23-03-24` [5d] | [[코드스쿼드] Max 3주차 회고 - JS 카페 미션](https://velog.io/@jinny-l/%EC%BD%94%EB%93%9C%EC%8A%A4%EC%BF%BC%EB%93%9C-Max-3%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0) |
